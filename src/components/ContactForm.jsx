...
function ContactForm() {
    ...
    return (
        <div className="relative flex items-top justify-center bg-green-800 bg-opacity-90 sm:items-center sm:pt-0 sm:mx-20 sm:my-10">
                ...
                <div className="mt-2 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6 mr- sm:rounded-lg">
                            ...
                            <p className="text-normal text-lg sm:text-2xl font-medium text-white mt-2 text-center">
